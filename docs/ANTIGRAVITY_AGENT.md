...
- **Xây dựng API Server & Memory Manager**: Tích hợp Context Memory (bộ nhớ ngắn hạn/dài hạn bằng SQLite/DB) và LLM Intent Routing, biến bot thành Antigravity Relay thông minh.
...
- **Import dữ liệu**: Viết và chạy script `normalize_data_v2.py` để chuẩn hóa 225 tài liệu sang cấu trúc phẳng và di chuyển sang `D:\MedicalData`.
- **Release Management**: Tự quyết định version, tạo tag, viết changelog, push GitHub (v2.1.0).
